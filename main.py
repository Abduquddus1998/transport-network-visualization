...
from network_data import network_dict, edge_colors, network_line_labels
...
def add_network_edges():
    for line in iter(network_dict):
        ...
        for i in range(0, len(network_line) - 1):
            ...
            network_graph.add_edge(current_node["short_name"], next_node["short_name"], color=line_color, weight=10)
